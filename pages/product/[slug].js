    ...
    <div className='product-detail-container'>
        ...
        <div className='product-detail-desc'>
            ...
            <div className='buttons'>
                ...
                <button type='button' className='buy-now' onClick={ handeBuyNow }>Buy Now</button>
            </div>
        </div>
    </div>
    <div className='bought-together-products-wrapper'>
        <h2>Frequently bought together</h2>
        <div className='marquee'>
            <div className='bought-together-products-container'>
                { products.filter( item => item.category === category && item.name !== name ).map( ( item ) =>(
